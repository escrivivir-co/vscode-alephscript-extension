...
class SocketMonitor {
    constructor() {
        ...
        this._onConnectionChange = new vscode.EventEmitter();
        this._onRoomsChange = new vscode.EventEmitter();
        this._onMessageReceived = new vscode.EventEmitter();
        this.onConnectionChange = this._onConnectionChange.event;
        this.onRoomsChange = this._onRoomsChange.event;
    ...
    async connectToSocket(url = 'ws://localhost:3000') {
    ...
    sendSocketMessage(roomName, eventType, data) {
